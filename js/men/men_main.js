$(document).ready(function() {
    var element = document.getElementsByClassName("men_side"); 
    ...
    function scrollevent() {
          if (document.body.scrollTop > 1300 || document.documentElement.scrollTop > 1300) {
            document.getElementById("video_over").style.backgroundColor="rgba(0,0,0,0.1)";
              ...
              document.querySelector("section.men_main-02").style.width="1880px";
              document.querySelector("section.men_main-02").style.height="1062px";
              document.querySelector("section.men_main-02").style.transition="all 2s ease";
              
              
          } else {
              document.getElementById("video_over").style.backgroundColor="rgba(0,0,0,1)";
              document.getElementById("video_over").style.transition="all 2s ease";
              document.querySelector("section.men_main-02").style.width="1680px";
              document.querySelector("section.men_main-02").style.height="862px";
              document.querySelector("section.men_main-02").style.transition="all 2s ease";
