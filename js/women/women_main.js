$(document).ready(function() {
    var element4 = document.getElementsByClassName("women_side"); 
    Stickyfill.add(element4);
    ...
    function scrollevent() {
          if (document.body.scrollTop > 1300 || document.documentElement.scrollTop > 1300) {
            document.getElementById("video_over").style.backgroundColor="rgba(0,0,0,0.1)";
              ...
              document.querySelector("section.women_main-02").style.width="1880px";
              document.querySelector("section.women_main-02").style.height="1062px";
              document.querySelector("section.women_main-02").style.transition="all 2s ease";
              
              
          } else {
              document.getElementById("video_over").style.backgroundColor="rgba(0,0,0,1)";
              document.getElementById("video_over").style.transition="all 2s ease";
              document.querySelector("section.women_main-02").style.width="1680px";
              document.querySelector("section.women_main-02").style.height="862px";
              document.querySelector("section.women_main-02").style.transition="all 2s ease";
...
//            document.querySelector(".f_img > p:nth-child(1)").style.opacity = "1";
    ...
    $(".fit img:nth-child(2)").hover(function() {
        $(this).css("opacity","0").css("transition","all 0.3s ease");
        $(this).css("cursor","pointer");
    },function() {
        $(this).css("opacity","1");
    });
